...
thbdb_item_list_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_STRUCT, (gint32) (this_object->items ? this_object->items->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i1 = 0; i1 < (this_object->items ? this_object->items->len : 0); i1++)
    {
...
thbdb_keys_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_STRING, (gint32) (this_object->key ? this_object->key->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i3 = 0; i3 < (this_object->key ? this_object->key->len : 0); i3++)
    {
